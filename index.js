...
const requireAdminView = require('./src/middleware/requireAdminView');
...
// Não servir automaticamente public/index.html para '/'caso contratio seria servido sem autenticação
...
app.get('/professions', requireAdminView, (req, res) => {
  res.sendFile(path.join(__dirname, 'public','html/professions.html'));
});

app.get('/generos', requireAdminView, (req, res) => {
